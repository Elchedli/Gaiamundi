...
const colorClasses: Record<Color, string> = {
  ...
  royalblue:
    'text-white bg-royal-blue-700 border border-transparent hover:bg-royal-blue-800 focus:ring-4 focus:ring-royal-blue-300 disabled:hover:bg-royal-blue-700 dark:bg-royal-blue-600 dark:hover:bg-royal-blue-700 dark:focus:ring-royal-blue-800 dark:disabled:hover:bg-royal-blue-600',
  alternative:
  ...
  lime: 'bg-lime-300 border border-transparent hover:bg-lime-400 focus:ring-4 focus:ring-lime-300 disabled:hover:bg-lime-700 dark:bg-lime-600 dark:hover:bg-lime-700 dark:focus:ring-lime-800 dark:disabled:hover:bg-lime-600',
  ...
  transparent:
    'text-black border border-transparent focus:ring-4 focus:ring-purple-300 dark:bg-purple-600',
};
...
const iconDimensionClasses: Record<Size, string> = {
  xs: 'w-2 h-2',
  sm: 'w-4 h-4',
  md: 'w-5 h-5',
  lg: 'w-6 h-6',
...
const ButtonComponent: FC<ButtonComponentProps> = ({
  ...
  >
    ...
    >
      {isLoading && (
        <Spinner
          className={classNames(iconDimensionClasses[size], 'animate-spin')}
        />
      )}
      {!isLoading && Icon && <Icon className={iconDimensionClasses[size]} />}
      {children}
      {label && (
        <span className="ml-4 inline-flex h-4 w-4 items-center justify-center rounded-full bg-blue-200 text-xs font-semibold text-blue-800">
          {label}
        </span>
      )}
    </span>
